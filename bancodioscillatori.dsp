...
//valore di inizializzazione(valore che troviamo all'inizio quando si avvia il programma, stato inziale) valore minimo valore massimo step incrementale cio̬ definizione dei numeri che troviamo tra il valore minimo e il valore massimo
//spettro armonico: un suono con spettro armonico contiene frequenze armoniche multiple intere della frequenza fondamentale per numero dell'armonico 
